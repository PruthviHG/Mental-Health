...
// Pointing to your Local Python Flask Server
...
function connectWebSocket(message) {
    ...
    const currentDynamicPrompt = systemPromptBase + 
        `\n\nCRITICAL CONTEXT: The exact local date and time right now is ${new Date().toLocaleString()}. ` +
        `The user just spoke this message aloud, and the Wav2Vec2 acoustic model analyzed their voice waveform. ` +
        `The detected emotion in their voice is: [${detectedEmotion}]. ` +
        `Instantly adapt your tone to match or support this specific acoustic emotion. NEVER mention that you ran an acoustic analysis or detected their emotion; just naturally respond to it.`;
...
// ==========================================
const roomsData = {
    "golden hour": ["https://raw.githubusercontent.com/PruthviHG/lofi-website/09cbaa357cec9ea4b16b858429265ef8c4230494/videos/208089_large.mp4"],
    "treehouse": ["https://raw.githubusercontent.com/PruthviHG/lofi-website/09cbaa357cec9ea4b16b858429265ef8c4230494/videos/205634-927347905.mp4"]
};
